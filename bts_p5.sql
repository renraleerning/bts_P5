...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2024 at 10:17 AM
...
CREATE TABLE `tbl_bagian` (
  `id` int(11) NOT NULL,
  `nama_bagian` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(18, 'Mesjid', '1'),
(19, 'Stand Pameran', '1'),
(20, 'Event Undangan Pernikahan', '1');
...
CREATE TABLE `tbl_jabatan` (
  `id` int(11) NOT NULL,
  `nama_jabatan` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('1','0') COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `tbl_tamu` (`id`, `nama`, `alamat`, `jenkel`, `no_hp`, `tujuan`, `tgl_datang`, `keperluan`, `nama_tujuan`, `photo`, `user_id`, `nama_user`, `kelas`) VALUES
(768, 'Ren', 'Sumedang', 'L', '0851586480272', 'Event Undangan Pernikahan', '2024-02-16 15:01:30', 'Menghadiri Pernikahan', '-', 'foto_ren_tamu_2024-02-16.jpeg', 1, 'Admin', '');
...
(1, 'Admin', 'Just do it', 'P', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'I am a mountainner. to me mountainerring is a life', 'erifebriantini22@guru.smk.belajar.id', '082116741672', 1, '1', '2022-02-03 06:07:55', '5e76c0f5a4561769e13e807cba352f9c.jpg'),
(7, 'Petugas', NULL, 'L', 'Petugas', 'afb91ef692fd08c445e8cb1bab2ccf9c', NULL, 'admin@gmail.com', '08111111', 1, '2', '2023-02-15 02:11:15', '8c6bdb151e19a1908f5b5a6c1f69b487.png'),
(8, 'Petugas2', NULL, 'P', 'petugas2', 'ac5604a8b8504d4ff5b842480df02e91', NULL, 'petugas2@gmail.com', '0987654321', 1, '1', '2023-02-23 07:53:59', '9924aeff6a48ab3bd7ab56e2efd4cb28.png'),
(9, 'Administrator', 'Im cool man', 'L', 'Administrator', '140528633b2b05000498de53f40b91e3', 'Im best man in the world.', 'administrator@gmail.com', '08936663112', 1, '2', '2023-10-08 16:13:50', NULL),
(10, 'Petugas Resepsionis', NULL, 'P', 'Resepsionis', '3aeff485f68b360d076de3d73f9247ad', NULL, 'resepsionis@gmail.com', '0800000', 1, '2', '2023-11-13 05:35:26', 'ea2e6229aa40a1e32ebd16fb62bd133a.jpg');
