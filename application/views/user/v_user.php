                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            if (!empty($fileName) && file_exists($fotoPath)) {
                                                echo "<img onclick='modalimage(this.src)' width='40' height='40' class='user-image' src=" . base_url() . "assets/images/" . $user_photo . ">";
                                            } else {
                                                echo "<img width='40' height='40' src='" . base_url() . "assets/images/user_blank.png' class='user-image' alt=''>";
                                            }
                                        ...
                                        <td style="text-align:center;">
                                            <a class="btn btn-sm btn-info" data-toggle="modal" data-target="#ModalEdit<?php echo $user_id; ?>"><span class="fa fa-pencil"></span></a>&nbsp;
                                            <a class="btn btn-sm btn-warning" href="<?php echo base_url() . 'user/reset_password/' . $user_id; ?>"><span class="fa fa-refresh"></span></a>&nbsp;
                                            <a class="btn btn-sm btn-danger" data-toggle="modal" data-target="#ModalHapus<?php echo $user_id; ?>"><span class="fa fa-trash"></span></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
